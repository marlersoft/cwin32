...
//--------------------------------------------------------------------------------
#define D3D10_16BIT_INDEX_STRIP_CUT_VALUE (UINT)65535
#define D3D10_32BIT_INDEX_STRIP_CUT_VALUE (UINT)4294967295
#define D3D10_8BIT_INDEX_STRIP_CUT_VALUE (UINT)255
#define D3D10_ARRAY_AXIS_ADDRESS_RANGE_BIT_COUNT (UINT)9
#define D3D10_CLIP_OR_CULL_DISTANCE_COUNT (UINT)8
#define D3D10_CLIP_OR_CULL_DISTANCE_ELEMENT_COUNT (UINT)2
#define D3D10_COMMONSHADER_CONSTANT_BUFFER_API_SLOT_COUNT (UINT)14
#define D3D10_COMMONSHADER_CONSTANT_BUFFER_COMPONENTS (UINT)4
#define D3D10_COMMONSHADER_CONSTANT_BUFFER_COMPONENT_BIT_COUNT (UINT)32
#define D3D10_COMMONSHADER_CONSTANT_BUFFER_HW_SLOT_COUNT (UINT)15
#define D3D10_COMMONSHADER_CONSTANT_BUFFER_REGISTER_COMPONENTS (UINT)4
#define D3D10_COMMONSHADER_CONSTANT_BUFFER_REGISTER_COUNT (UINT)15
#define D3D10_COMMONSHADER_CONSTANT_BUFFER_REGISTER_READS_PER_INST (UINT)1
#define D3D10_COMMONSHADER_CONSTANT_BUFFER_REGISTER_READ_PORTS (UINT)1
#define D3D10_COMMONSHADER_FLOWCONTROL_NESTING_LIMIT (UINT)64
#define D3D10_COMMONSHADER_IMMEDIATE_CONSTANT_BUFFER_REGISTER_COMPONENTS (UINT)4
#define D3D10_COMMONSHADER_IMMEDIATE_CONSTANT_BUFFER_REGISTER_COUNT (UINT)1
#define D3D10_COMMONSHADER_IMMEDIATE_CONSTANT_BUFFER_REGISTER_READS_PER_INST (UINT)1
#define D3D10_COMMONSHADER_IMMEDIATE_CONSTANT_BUFFER_REGISTER_READ_PORTS (UINT)1
#define D3D10_COMMONSHADER_IMMEDIATE_VALUE_COMPONENT_BIT_COUNT (UINT)32
#define D3D10_COMMONSHADER_INPUT_RESOURCE_REGISTER_COMPONENTS (UINT)1
#define D3D10_COMMONSHADER_INPUT_RESOURCE_REGISTER_COUNT (UINT)128
#define D3D10_COMMONSHADER_INPUT_RESOURCE_REGISTER_READS_PER_INST (UINT)1
#define D3D10_COMMONSHADER_INPUT_RESOURCE_REGISTER_READ_PORTS (UINT)1
#define D3D10_COMMONSHADER_INPUT_RESOURCE_SLOT_COUNT (UINT)128
#define D3D10_COMMONSHADER_SAMPLER_REGISTER_COMPONENTS (UINT)1
#define D3D10_COMMONSHADER_SAMPLER_REGISTER_COUNT (UINT)16
#define D3D10_COMMONSHADER_SAMPLER_REGISTER_READS_PER_INST (UINT)1
#define D3D10_COMMONSHADER_SAMPLER_REGISTER_READ_PORTS (UINT)1
#define D3D10_COMMONSHADER_SAMPLER_SLOT_COUNT (UINT)16
#define D3D10_COMMONSHADER_SUBROUTINE_NESTING_LIMIT (UINT)32
#define D3D10_COMMONSHADER_TEMP_REGISTER_COMPONENTS (UINT)4
#define D3D10_COMMONSHADER_TEMP_REGISTER_COMPONENT_BIT_COUNT (UINT)32
#define D3D10_COMMONSHADER_TEMP_REGISTER_COUNT (UINT)4096
#define D3D10_COMMONSHADER_TEMP_REGISTER_READS_PER_INST (UINT)3
#define D3D10_COMMONSHADER_TEMP_REGISTER_READ_PORTS (UINT)3
#define D3D10_COMMONSHADER_TEXCOORD_RANGE_REDUCTION_MAX (UINT)10
#define D3D10_COMMONSHADER_TEXCOORD_RANGE_REDUCTION_MIN (INT)-10
#define D3D10_COMMONSHADER_TEXEL_OFFSET_MAX_NEGATIVE (INT)-8
#define D3D10_COMMONSHADER_TEXEL_OFFSET_MAX_POSITIVE (UINT)7
#define D3D10_DEFAULT_BLEND_FACTOR_ALPHA (FLOAT)1
#define D3D10_DEFAULT_BLEND_FACTOR_BLUE (FLOAT)1
#define D3D10_DEFAULT_BLEND_FACTOR_GREEN (FLOAT)1
#define D3D10_DEFAULT_BLEND_FACTOR_RED (FLOAT)1
#define D3D10_DEFAULT_BORDER_COLOR_COMPONENT (FLOAT)0
#define D3D10_DEFAULT_DEPTH_BIAS (UINT)0
#define D3D10_DEFAULT_DEPTH_BIAS_CLAMP (FLOAT)0
#define D3D10_DEFAULT_MAX_ANISOTROPY (FLOAT)16
#define D3D10_DEFAULT_MIP_LOD_BIAS (FLOAT)0
#define D3D10_DEFAULT_RENDER_TARGET_ARRAY_INDEX (UINT)0
#define D3D10_DEFAULT_SAMPLE_MASK (UINT)4294967295
#define D3D10_DEFAULT_SCISSOR_ENDX (UINT)0
#define D3D10_DEFAULT_SCISSOR_ENDY (UINT)0
#define D3D10_DEFAULT_SCISSOR_STARTX (UINT)0
#define D3D10_DEFAULT_SCISSOR_STARTY (UINT)0
#define D3D10_DEFAULT_SLOPE_SCALED_DEPTH_BIAS (FLOAT)0
#define D3D10_DEFAULT_STENCIL_READ_MASK (UINT)255
#define D3D10_DEFAULT_STENCIL_REFERENCE (UINT)0
#define D3D10_DEFAULT_STENCIL_WRITE_MASK (UINT)255
#define D3D10_DEFAULT_VIEWPORT_AND_SCISSORRECT_INDEX (UINT)0
#define D3D10_DEFAULT_VIEWPORT_HEIGHT (UINT)0
#define D3D10_DEFAULT_VIEWPORT_MAX_DEPTH (FLOAT)0
#define D3D10_DEFAULT_VIEWPORT_MIN_DEPTH (FLOAT)0
#define D3D10_DEFAULT_VIEWPORT_TOPLEFTX (UINT)0
#define D3D10_DEFAULT_VIEWPORT_TOPLEFTY (UINT)0
#define D3D10_DEFAULT_VIEWPORT_WIDTH (UINT)0
#define D3D10_FLOAT16_FUSED_TOLERANCE_IN_ULP (DOUBLE)6.0e-01
#define D3D10_FLOAT32_MAX (FLOAT)3.4028235e+38
#define D3D10_FLOAT32_TO_INTEGER_TOLERANCE_IN_ULP (FLOAT)6.0e-01
#define D3D10_FLOAT_TO_SRGB_EXPONENT_DENOMINATOR (FLOAT)2.4e+00
#define D3D10_FLOAT_TO_SRGB_EXPONENT_NUMERATOR (FLOAT)1
#define D3D10_FLOAT_TO_SRGB_OFFSET (FLOAT)5.5e-02
#define D3D10_FLOAT_TO_SRGB_SCALE_1 (FLOAT)1.292e+01
#define D3D10_FLOAT_TO_SRGB_SCALE_2 (FLOAT)1.055e+00
#define D3D10_FLOAT_TO_SRGB_THRESHOLD (FLOAT)3.1308e-03
#define D3D10_FTOI_INSTRUCTION_MAX_INPUT (FLOAT)2.1474836e+09
#define D3D10_FTOI_INSTRUCTION_MIN_INPUT (FLOAT)-2.1474836e+09
#define D3D10_FTOU_INSTRUCTION_MAX_INPUT (FLOAT)4.2949673e+09
#define D3D10_FTOU_INSTRUCTION_MIN_INPUT (FLOAT)0
#define D3D10_GS_INPUT_PRIM_CONST_REGISTER_COMPONENTS (UINT)1
#define D3D10_GS_INPUT_PRIM_CONST_REGISTER_COMPONENT_BIT_COUNT (UINT)32
#define D3D10_GS_INPUT_PRIM_CONST_REGISTER_COUNT (UINT)1
#define D3D10_GS_INPUT_PRIM_CONST_REGISTER_READS_PER_INST (UINT)2
#define D3D10_GS_INPUT_PRIM_CONST_REGISTER_READ_PORTS (UINT)1
#define D3D10_GS_INPUT_REGISTER_COMPONENTS (UINT)4
#define D3D10_GS_INPUT_REGISTER_COMPONENT_BIT_COUNT (UINT)32
#define D3D10_GS_INPUT_REGISTER_COUNT (UINT)16
#define D3D10_GS_INPUT_REGISTER_READS_PER_INST (UINT)2
#define D3D10_GS_INPUT_REGISTER_READ_PORTS (UINT)1
#define D3D10_GS_INPUT_REGISTER_VERTICES (UINT)6
#define D3D10_GS_OUTPUT_ELEMENTS (UINT)32
#define D3D10_GS_OUTPUT_REGISTER_COMPONENTS (UINT)4
#define D3D10_GS_OUTPUT_REGISTER_COMPONENT_BIT_COUNT (UINT)32
#define D3D10_GS_OUTPUT_REGISTER_COUNT (UINT)32
#define D3D10_IA_DEFAULT_INDEX_BUFFER_OFFSET_IN_BYTES (UINT)0
#define D3D10_IA_DEFAULT_PRIMITIVE_TOPOLOGY (UINT)0
#define D3D10_IA_DEFAULT_VERTEX_BUFFER_OFFSET_IN_BYTES (UINT)0
#define D3D10_IA_INDEX_INPUT_RESOURCE_SLOT_COUNT (UINT)1
#define D3D10_IA_INSTANCE_ID_BIT_COUNT (UINT)32
#define D3D10_IA_INTEGER_ARITHMETIC_BIT_COUNT (UINT)32
#define D3D10_IA_PRIMITIVE_ID_BIT_COUNT (UINT)32
#define D3D10_IA_VERTEX_ID_BIT_COUNT (UINT)32
#define D3D10_IA_VERTEX_INPUT_RESOURCE_SLOT_COUNT (UINT)16
#define D3D10_IA_VERTEX_INPUT_STRUCTURE_ELEMENTS_COMPONENTS (UINT)64
#define D3D10_IA_VERTEX_INPUT_STRUCTURE_ELEMENT_COUNT (UINT)16
#define D3D10_INTEGER_DIVIDE_BY_ZERO_QUOTIENT (UINT)4294967295
#define D3D10_INTEGER_DIVIDE_BY_ZERO_REMAINDER (UINT)4294967295
#define D3D10_LINEAR_GAMMA (FLOAT)1
#define D3D10_MAX_BORDER_COLOR_COMPONENT (FLOAT)1
#define D3D10_MAX_DEPTH (FLOAT)1
#define D3D10_MAX_MAXANISOTROPY (UINT)16
#define D3D10_MAX_MULTISAMPLE_SAMPLE_COUNT (UINT)32
#define D3D10_MAX_POSITION_VALUE (FLOAT)3.4028236e+34
#define D3D10_MAX_TEXTURE_DIMENSION_2_TO_EXP (UINT)17
#define D3D10_MIN_BORDER_COLOR_COMPONENT (FLOAT)0
#define D3D10_MIN_DEPTH (FLOAT)0
#define D3D10_MIN_MAXANISOTROPY (UINT)0
#define D3D10_MIP_LOD_BIAS_MAX (FLOAT)1.599e+01
#define D3D10_MIP_LOD_BIAS_MIN (FLOAT)-16
#define D3D10_MIP_LOD_FRACTIONAL_BIT_COUNT (UINT)6
#define D3D10_MIP_LOD_RANGE_BIT_COUNT (UINT)8
#define D3D10_MULTISAMPLE_ANTIALIAS_LINE_WIDTH (FLOAT)1.4e+00
#define D3D10_NONSAMPLE_FETCH_OUT_OF_RANGE_ACCESS_RESULT (UINT)0
#define D3D10_PIXEL_ADDRESS_RANGE_BIT_COUNT (UINT)13
#define D3D10_PRE_SCISSOR_PIXEL_ADDRESS_RANGE_BIT_COUNT (UINT)15
#define D3D10_PS_FRONTFACING_DEFAULT_VALUE (UINT)4294967295
#define D3D10_PS_FRONTFACING_FALSE_VALUE (UINT)0
#define D3D10_PS_FRONTFACING_TRUE_VALUE (UINT)4294967295
#define D3D10_PS_INPUT_REGISTER_COMPONENTS (UINT)4
#define D3D10_PS_INPUT_REGISTER_COMPONENT_BIT_COUNT (UINT)32
#define D3D10_PS_INPUT_REGISTER_COUNT (UINT)32
#define D3D10_PS_INPUT_REGISTER_READS_PER_INST (UINT)2
#define D3D10_PS_INPUT_REGISTER_READ_PORTS (UINT)1
#define D3D10_PS_LEGACY_PIXEL_CENTER_FRACTIONAL_COMPONENT (FLOAT)0
#define D3D10_PS_OUTPUT_DEPTH_REGISTER_COMPONENTS (UINT)1
#define D3D10_PS_OUTPUT_DEPTH_REGISTER_COMPONENT_BIT_COUNT (UINT)32
#define D3D10_PS_OUTPUT_DEPTH_REGISTER_COUNT (UINT)1
#define D3D10_PS_OUTPUT_REGISTER_COMPONENTS (UINT)4
#define D3D10_PS_OUTPUT_REGISTER_COMPONENT_BIT_COUNT (UINT)32
#define D3D10_PS_OUTPUT_REGISTER_COUNT (UINT)8
#define D3D10_PS_PIXEL_CENTER_FRACTIONAL_COMPONENT (FLOAT)5.0e-01
#define D3D10_REQ_BLEND_OBJECT_COUNT_PER_CONTEXT (UINT)4096
#define D3D10_REQ_BUFFER_RESOURCE_TEXEL_COUNT_2_TO_EXP (UINT)27
#define D3D10_REQ_CONSTANT_BUFFER_ELEMENT_COUNT (UINT)4096
#define D3D10_REQ_DEPTH_STENCIL_OBJECT_COUNT_PER_CONTEXT (UINT)4096
#define D3D10_REQ_DRAWINDEXED_INDEX_COUNT_2_TO_EXP (UINT)32
#define D3D10_REQ_DRAW_VERTEX_COUNT_2_TO_EXP (UINT)32
#define D3D10_REQ_FILTERING_HW_ADDRESSABLE_RESOURCE_DIMENSION (UINT)8192
#define D3D10_REQ_GS_INVOCATION_32BIT_OUTPUT_COMPONENT_LIMIT (UINT)1024
#define D3D10_REQ_IMMEDIATE_CONSTANT_BUFFER_ELEMENT_COUNT (UINT)4096
#define D3D10_REQ_MAXANISOTROPY (UINT)16
#define D3D10_REQ_MIP_LEVELS (UINT)14
#define D3D10_REQ_MULTI_ELEMENT_STRUCTURE_SIZE_IN_BYTES (UINT)2048
#define D3D10_REQ_RASTERIZER_OBJECT_COUNT_PER_CONTEXT (UINT)4096
#define D3D10_REQ_RENDER_TO_BUFFER_WINDOW_WIDTH (UINT)8192
#define D3D10_REQ_RESOURCE_SIZE_IN_MEGABYTES (UINT)128
#define D3D10_REQ_RESOURCE_VIEW_COUNT_PER_CONTEXT_2_TO_EXP (UINT)20
#define D3D10_REQ_SAMPLER_OBJECT_COUNT_PER_CONTEXT (UINT)4096
#define D3D10_REQ_TEXTURE1D_ARRAY_AXIS_DIMENSION (UINT)512
#define D3D10_REQ_TEXTURE1D_U_DIMENSION (UINT)8192
#define D3D10_REQ_TEXTURE2D_ARRAY_AXIS_DIMENSION (UINT)512
#define D3D10_REQ_TEXTURE2D_U_OR_V_DIMENSION (UINT)8192
#define D3D10_REQ_TEXTURE3D_U_V_OR_W_DIMENSION (UINT)2048
#define D3D10_REQ_TEXTURECUBE_DIMENSION (UINT)8192
#define D3D10_RESINFO_INSTRUCTION_MISSING_COMPONENT_RETVAL (UINT)0
#define D3D10_SHADER_MAJOR_VERSION (UINT)4
#define D3D10_SHADER_MINOR_VERSION (UINT)0
#define D3D10_SHIFT_INSTRUCTION_PAD_VALUE (UINT)0
#define D3D10_SHIFT_INSTRUCTION_SHIFT_VALUE_BIT_COUNT (UINT)5
#define D3D10_SIMULTANEOUS_RENDER_TARGET_COUNT (UINT)8
#define D3D10_SO_BUFFER_MAX_STRIDE_IN_BYTES (UINT)2048
#define D3D10_SO_BUFFER_MAX_WRITE_WINDOW_IN_BYTES (UINT)256
#define D3D10_SO_BUFFER_SLOT_COUNT (UINT)4
#define D3D10_SO_DDI_REGISTER_INDEX_DENOTING_GAP (UINT)4294967295
#define D3D10_SO_MULTIPLE_BUFFER_ELEMENTS_PER_BUFFER (UINT)1
#define D3D10_SO_SINGLE_BUFFER_COMPONENT_LIMIT (UINT)64
#define D3D10_SRGB_GAMMA (FLOAT)2.2e+00
#define D3D10_SRGB_TO_FLOAT_DENOMINATOR_1 (FLOAT)1.292e+01
#define D3D10_SRGB_TO_FLOAT_DENOMINATOR_2 (FLOAT)1.055e+00
#define D3D10_SRGB_TO_FLOAT_EXPONENT (FLOAT)2.4e+00
#define D3D10_SRGB_TO_FLOAT_OFFSET (FLOAT)5.5e-02
#define D3D10_SRGB_TO_FLOAT_THRESHOLD (FLOAT)4.045e-02
#define D3D10_SRGB_TO_FLOAT_TOLERANCE_IN_ULP (FLOAT)5.0e-01
#define D3D10_STANDARD_COMPONENT_BIT_COUNT (UINT)32
#define D3D10_STANDARD_COMPONENT_BIT_COUNT_DOUBLED (UINT)64
#define D3D10_STANDARD_MAXIMUM_ELEMENT_ALIGNMENT_BYTE_MULTIPLE (UINT)4
#define D3D10_STANDARD_PIXEL_COMPONENT_COUNT (UINT)128
#define D3D10_STANDARD_PIXEL_ELEMENT_COUNT (UINT)32
#define D3D10_STANDARD_VECTOR_SIZE (UINT)4
#define D3D10_STANDARD_VERTEX_ELEMENT_COUNT (UINT)16
#define D3D10_STANDARD_VERTEX_TOTAL_COMPONENT_COUNT (UINT)64
#define D3D10_SUBPIXEL_FRACTIONAL_BIT_COUNT (UINT)8
#define D3D10_SUBTEXEL_FRACTIONAL_BIT_COUNT (UINT)6
#define D3D10_TEXEL_ADDRESS_RANGE_BIT_COUNT (UINT)18
#define D3D10_UNBOUND_MEMORY_ACCESS_RESULT (UINT)0
#define D3D10_VIEWPORT_AND_SCISSORRECT_MAX_INDEX (UINT)15
#define D3D10_VIEWPORT_AND_SCISSORRECT_OBJECT_COUNT_PER_PIPELINE (UINT)16
#define D3D10_VIEWPORT_BOUNDS_MAX (UINT)16383
#define D3D10_VIEWPORT_BOUNDS_MIN (INT)-16384
#define D3D10_VS_INPUT_REGISTER_COMPONENTS (UINT)4
#define D3D10_VS_INPUT_REGISTER_COMPONENT_BIT_COUNT (UINT)32
#define D3D10_VS_INPUT_REGISTER_COUNT (UINT)16
#define D3D10_VS_INPUT_REGISTER_READS_PER_INST (UINT)2
#define D3D10_VS_INPUT_REGISTER_READ_PORTS (UINT)1
#define D3D10_VS_OUTPUT_REGISTER_COMPONENTS (UINT)4
#define D3D10_VS_OUTPUT_REGISTER_COMPONENT_BIT_COUNT (UINT)32
#define D3D10_VS_OUTPUT_REGISTER_COUNT (UINT)16
#define D3D10_WHQL_CONTEXT_COUNT_FOR_RESOURCE_LIMIT (UINT)10
#define D3D10_WHQL_DRAWINDEXED_INDEX_COUNT_2_TO_EXP (UINT)25
#define D3D10_WHQL_DRAW_VERTEX_COUNT_2_TO_EXP (UINT)25
#define D3D_MAJOR_VERSION (UINT)10
#define D3D_MINOR_VERSION (UINT)0
#define D3D_SPEC_DATE_DAY (UINT)8
#define D3D_SPEC_DATE_MONTH (UINT)8
#define D3D_SPEC_DATE_YEAR (UINT)2006
#define D3D_SPEC_VERSION (DOUBLE)1.050005e+00
#define _FACD3D10 (UINT)2169
#define D3D10_APPEND_ALIGNED_ELEMENT (UINT)4294967295
#define D3D10_FILTER_TYPE_MASK (UINT)3
#define D3D10_MIN_FILTER_SHIFT (UINT)4
#define D3D10_MAG_FILTER_SHIFT (UINT)2
#define D3D10_MIP_FILTER_SHIFT (UINT)0
#define D3D10_COMPARISON_FILTERING_BIT (UINT)128
#define D3D10_ANISOTROPIC_FILTERING_BIT (UINT)64
#define D3D10_TEXT_1BIT_BIT (UINT)2147483648
#define D3D10_SDK_VERSION (UINT)29
#define D3D10_1_DEFAULT_SAMPLE_MASK (UINT)4294967295
#define D3D10_1_FLOAT16_FUSED_TOLERANCE_IN_ULP (DOUBLE)6.0e-01
#define D3D10_1_FLOAT32_TO_INTEGER_TOLERANCE_IN_ULP (FLOAT)6.0e-01
#define D3D10_1_GS_INPUT_REGISTER_COUNT (UINT)32
#define D3D10_1_IA_VERTEX_INPUT_RESOURCE_SLOT_COUNT (UINT)32
#define D3D10_1_IA_VERTEX_INPUT_STRUCTURE_ELEMENTS_COMPONENTS (UINT)128
#define D3D10_1_IA_VERTEX_INPUT_STRUCTURE_ELEMENT_COUNT (UINT)32
#define D3D10_1_PS_OUTPUT_MASK_REGISTER_COMPONENTS (UINT)1
#define D3D10_1_PS_OUTPUT_MASK_REGISTER_COMPONENT_BIT_COUNT (UINT)32
#define D3D10_1_PS_OUTPUT_MASK_REGISTER_COUNT (UINT)1
#define D3D10_1_SHADER_MAJOR_VERSION (UINT)4
#define D3D10_1_SHADER_MINOR_VERSION (UINT)1
#define D3D10_1_SO_BUFFER_MAX_STRIDE_IN_BYTES (UINT)2048
#define D3D10_1_SO_BUFFER_MAX_WRITE_WINDOW_IN_BYTES (UINT)256
#define D3D10_1_SO_BUFFER_SLOT_COUNT (UINT)4
#define D3D10_1_SO_MULTIPLE_BUFFER_ELEMENTS_PER_BUFFER (UINT)1
#define D3D10_1_SO_SINGLE_BUFFER_COMPONENT_LIMIT (UINT)64
#define D3D10_1_STANDARD_VERTEX_ELEMENT_COUNT (UINT)32
#define D3D10_1_SUBPIXEL_FRACTIONAL_BIT_COUNT (UINT)8
#define D3D10_1_VS_INPUT_REGISTER_COUNT (UINT)32
#define D3D10_1_VS_OUTPUT_REGISTER_COUNT (UINT)32
#define D3D10_SDK_LAYERS_VERSION (UINT)11
#define D3D10_DEBUG_FEATURE_FLUSH_PER_RENDER_OP (UINT)1
#define D3D10_DEBUG_FEATURE_FINISH_PER_RENDER_OP (UINT)2
#define D3D10_DEBUG_FEATURE_PRESENT_PER_RENDER_OP (UINT)4
#define DXGI_DEBUG_D3D10 GUID { "243b4c52-3606-4d3a-99d7-a7e7b33ed706" }
#define D3D10_INFO_QUEUE_DEFAULT_MESSAGE_COUNT_LIMIT (UINT)1024
#define D3D10_SHADER_DEBUG (UINT)1
#define D3D10_SHADER_SKIP_VALIDATION (UINT)2
#define D3D10_SHADER_SKIP_OPTIMIZATION (UINT)4
#define D3D10_SHADER_PACK_MATRIX_ROW_MAJOR (UINT)8
#define D3D10_SHADER_PACK_MATRIX_COLUMN_MAJOR (UINT)16
#define D3D10_SHADER_PARTIAL_PRECISION (UINT)32
#define D3D10_SHADER_FORCE_VS_SOFTWARE_NO_OPT (UINT)64
#define D3D10_SHADER_FORCE_PS_SOFTWARE_NO_OPT (UINT)128
#define D3D10_SHADER_NO_PRESHADER (UINT)256
#define D3D10_SHADER_AVOID_FLOW_CONTROL (UINT)512
#define D3D10_SHADER_PREFER_FLOW_CONTROL (UINT)1024
#define D3D10_SHADER_ENABLE_STRICTNESS (UINT)2048
#define D3D10_SHADER_ENABLE_BACKWARDS_COMPATIBILITY (UINT)4096
#define D3D10_SHADER_IEEE_STRICTNESS (UINT)8192
#define D3D10_SHADER_WARNINGS_ARE_ERRORS (UINT)262144
#define D3D10_SHADER_RESOURCES_MAY_ALIAS (UINT)524288
#define D3D10_ENABLE_UNBOUNDED_DESCRIPTOR_TABLES (UINT)1048576
#define D3D10_ALL_RESOURCES_BOUND (UINT)2097152
#define D3D10_SHADER_DEBUG_NAME_FOR_SOURCE (UINT)4194304
#define D3D10_SHADER_DEBUG_NAME_FOR_BINARY (UINT)8388608
#define D3D10_SHADER_OPTIMIZATION_LEVEL0 (UINT)16384
#define D3D10_SHADER_OPTIMIZATION_LEVEL1 (UINT)0
#define D3D10_SHADER_OPTIMIZATION_LEVEL3 (UINT)32768
#define D3D10_SHADER_FLAGS2_FORCE_ROOT_SIGNATURE_LATEST (UINT)0
#define D3D10_SHADER_FLAGS2_FORCE_ROOT_SIGNATURE_1_0 (UINT)16
#define D3D10_SHADER_FLAGS2_FORCE_ROOT_SIGNATURE_1_1 (UINT)32
#define D3D10_EFFECT_COMPILE_CHILD_EFFECT (UINT)1
#define D3D10_EFFECT_COMPILE_ALLOW_SLOW_OPS (UINT)2
#define D3D10_EFFECT_SINGLE_THREADED (UINT)8
#define D3D10_EFFECT_VARIABLE_POOLED (UINT)1
#define D3D10_EFFECT_VARIABLE_ANNOTATION (UINT)2
#define D3D10_EFFECT_VARIABLE_EXPLICIT_BIND_POINT (UINT)4
#define GUID_DeviceType GUID { "d722fb4d-7a68-437a-b20c-5804ee2494a6" }
...
typedef int D3D10_SO_DECLARATION_ENTRY;

typedef int D3D10_VIEWPORT;
...
typedef int D3D10_BOX;

typedef int ID3D10DeviceChild;
...
typedef int D3D10_DEPTH_STENCILOP_DESC;

typedef int D3D10_DEPTH_STENCIL_DESC;

typedef int ID3D10DepthStencilState;
...
typedef int D3D10_BLEND_DESC;

typedef int ID3D10BlendState;

typedef int D3D10_RASTERIZER_DESC;

typedef int ID3D10RasterizerState;

typedef int D3D10_SUBRESOURCE_DATA;

typedef int ID3D10Resource;

typedef int D3D10_BUFFER_DESC;

typedef int ID3D10Buffer;

typedef int D3D10_TEXTURE1D_DESC;

typedef int ID3D10Texture1D;

typedef int D3D10_TEXTURE2D_DESC;

typedef int D3D10_MAPPED_TEXTURE2D;

typedef int ID3D10Texture2D;

typedef int D3D10_TEXTURE3D_DESC;

typedef int D3D10_MAPPED_TEXTURE3D;

typedef int ID3D10Texture3D;
...
typedef int ID3D10View;

typedef int D3D10_BUFFER_SRV;

typedef int D3D10_TEX1D_SRV;

typedef int D3D10_TEX1D_ARRAY_SRV;

typedef int D3D10_TEX2D_SRV;

typedef int D3D10_TEX2D_ARRAY_SRV;

typedef int D3D10_TEX3D_SRV;

typedef int D3D10_TEXCUBE_SRV;

typedef int D3D10_TEX2DMS_SRV;

typedef int D3D10_TEX2DMS_ARRAY_SRV;

typedef int D3D10_SHADER_RESOURCE_VIEW_DESC;

typedef int ID3D10ShaderResourceView;

typedef int D3D10_BUFFER_RTV;

typedef int D3D10_TEX1D_RTV;

typedef int D3D10_TEX1D_ARRAY_RTV;

typedef int D3D10_TEX2D_RTV;

typedef int D3D10_TEX2DMS_RTV;

typedef int D3D10_TEX2D_ARRAY_RTV;

typedef int D3D10_TEX2DMS_ARRAY_RTV;

typedef int D3D10_TEX3D_RTV;

typedef int D3D10_RENDER_TARGET_VIEW_DESC;

typedef int ID3D10RenderTargetView;

typedef int D3D10_TEX1D_DSV;

typedef int D3D10_TEX1D_ARRAY_DSV;

typedef int D3D10_TEX2D_DSV;

typedef int D3D10_TEX2D_ARRAY_DSV;

typedef int D3D10_TEX2DMS_DSV;

typedef int D3D10_TEX2DMS_ARRAY_DSV;

typedef int D3D10_DEPTH_STENCIL_VIEW_DESC;

typedef int ID3D10DepthStencilView;

typedef int ID3D10VertexShader;

typedef int ID3D10GeometryShader;

typedef int ID3D10PixelShader;

typedef int ID3D10InputLayout;
...
typedef int D3D10_SAMPLER_DESC;

typedef int ID3D10SamplerState;
...
typedef int ID3D10Asynchronous;
...
typedef int D3D10_QUERY_DESC;

typedef int ID3D10Query;

typedef int ID3D10Predicate;

typedef int D3D10_QUERY_DATA_TIMESTAMP_DISJOINT;

typedef int D3D10_QUERY_DATA_PIPELINE_STATISTICS;

typedef int D3D10_QUERY_DATA_SO_STATISTICS;
...
typedef int D3D10_COUNTER_DESC;

typedef int D3D10_COUNTER_INFO;

typedef int ID3D10Counter;

typedef int ID3D10Device;
...
typedef int ID3D10Debug;

typedef int ID3D10SwitchToRef;
...
typedef int D3D10_MESSAGE;

typedef int D3D10_INFO_QUEUE_FILTER_DESC;

typedef int D3D10_INFO_QUEUE_FILTER;

typedef int ID3D10InfoQueue;
...
typedef int D3D10_SHADER_DESC;

typedef int D3D10_SHADER_BUFFER_DESC;

typedef int D3D10_SHADER_VARIABLE_DESC;

typedef int D3D10_SHADER_TYPE_DESC;

typedef int D3D10_SHADER_INPUT_BIND_DESC;

typedef int D3D10_SIGNATURE_PARAMETER_DESC;

typedef int ID3D10ShaderReflectionType;

typedef int ID3D10ShaderReflectionVariable;

typedef int ID3D10ShaderReflectionConstantBuffer;
...
typedef int D3D10_STATE_BLOCK_MASK;

typedef int ID3D10StateBlock;

typedef int D3D10_EFFECT_TYPE_DESC;

typedef int ID3D10EffectType;

typedef int D3D10_EFFECT_VARIABLE_DESC;

typedef int ID3D10EffectVariable;

typedef int ID3D10EffectScalarVariable;

typedef int ID3D10EffectVectorVariable;

typedef int ID3D10EffectMatrixVariable;

typedef int ID3D10EffectStringVariable;

typedef int ID3D10EffectShaderResourceVariable;

typedef int ID3D10EffectRenderTargetViewVariable;

typedef int ID3D10EffectDepthStencilViewVariable;

typedef int ID3D10EffectConstantBuffer;

typedef int D3D10_EFFECT_SHADER_DESC;

typedef int ID3D10EffectShaderVariable;

typedef int ID3D10EffectBlendVariable;

typedef int ID3D10EffectDepthStencilVariable;

typedef int ID3D10EffectRasterizerVariable;

typedef int ID3D10EffectSamplerVariable;

typedef int D3D10_PASS_DESC;

typedef int D3D10_PASS_SHADER_DESC;

typedef int ID3D10EffectPass;

typedef int D3D10_TECHNIQUE_DESC;

typedef int ID3D10EffectTechnique;

typedef int D3D10_EFFECT_DESC;

typedef int ID3D10Effect;

typedef int ID3D10EffectPool;
...
typedef int D3D10_RENDER_TARGET_BLEND_DESC1;

typedef int D3D10_BLEND_DESC1;

typedef int ID3D10BlendState1;

typedef int D3D10_TEXCUBE_ARRAY_SRV1;

typedef int D3D10_SHADER_RESOURCE_VIEW_DESC1;

typedef int ID3D10ShaderResourceView1;
...
typedef int D3D10_SHADER_DEBUG_TOKEN_INFO;

typedef int D3D10_SHADER_DEBUG_VAR_INFO;

typedef int D3D10_SHADER_DEBUG_INPUT_INFO;

typedef int D3D10_SHADER_DEBUG_SCOPEVAR_INFO;

typedef int D3D10_SHADER_DEBUG_SCOPE_INFO;

typedef int D3D10_SHADER_DEBUG_OUTPUTVAR;

typedef int D3D10_SHADER_DEBUG_OUTPUTREG_INFO;

typedef int D3D10_SHADER_DEBUG_INST_INFO;

typedef int D3D10_SHADER_DEBUG_FILE_INFO;

typedef int D3D10_SHADER_DEBUG_INFO;

typedef int ID3D10ShaderReflection1;

typedef int PFN_D3D10_CREATE_DEVICE1;

typedef int PFN_D3D10_CREATE_DEVICE_AND_SWAP_CHAIN1;


//--------------------------------------------------------------------------------
// Section: Functions (29)
//--------------------------------------------------------------------------------
/*HRESULT*/void D3D10CreateDevice();

/*HRESULT*/void D3D10CreateDeviceAndSwapChain();

/*HRESULT*/void D3D10CreateBlob();

/*HRESULT*/void D3D10CompileShader();

/*HRESULT*/void D3D10DisassembleShader();

/*PSTR*/void D3D10GetPixelShaderProfile();

/*PSTR*/void D3D10GetVertexShaderProfile();

/*PSTR*/void D3D10GetGeometryShaderProfile();

/*HRESULT*/void D3D10ReflectShader();

/*HRESULT*/void D3D10PreprocessShader();

/*HRESULT*/void D3D10GetInputSignatureBlob();

/*HRESULT*/void D3D10GetOutputSignatureBlob();

/*HRESULT*/void D3D10GetInputAndOutputSignatureBlob();

/*HRESULT*/void D3D10GetShaderDebugInfo();

/*HRESULT*/void D3D10StateBlockMaskUnion();

/*HRESULT*/void D3D10StateBlockMaskIntersect();

/*HRESULT*/void D3D10StateBlockMaskDifference();

/*HRESULT*/void D3D10StateBlockMaskEnableCapture();

/*HRESULT*/void D3D10StateBlockMaskDisableCapture();

/*HRESULT*/void D3D10StateBlockMaskEnableAll();

/*HRESULT*/void D3D10StateBlockMaskDisableAll();

/*BOOL*/void D3D10StateBlockMaskGetSetting();

/*HRESULT*/void D3D10CreateStateBlock();

/*HRESULT*/void D3D10CompileEffectFromMemory();

/*HRESULT*/void D3D10CreateEffectFromMemory();

/*HRESULT*/void D3D10CreateEffectPoolFromMemory();

/*HRESULT*/void D3D10DisassembleEffect();

/*HRESULT*/void D3D10CreateDevice1();

/*HRESULT*/void D3D10CreateDeviceAndSwapChain1();
