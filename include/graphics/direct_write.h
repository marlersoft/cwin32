...
// Section: Constants (7)
//--------------------------------------------------------------------------------
#define DWRITE_ALPHA_MAX (UINT)255
#define FACILITY_DWRITE (UINT)2200
#define DWRITE_ERR_BASE (UINT)20480
#define DWRITE_E_REMOTEFONT (HRESULT)(INT)-2003283955
#define DWRITE_E_DOWNLOADCANCELLED (HRESULT)(INT)-2003283954
#define DWRITE_E_DOWNLOADFAILED (HRESULT)(INT)-2003283953
#define DWRITE_E_TOOMANYDOWNLOADS (HRESULT)(INT)-2003283952
...
typedef int DWRITE_FONT_METRICS;

typedef int DWRITE_GLYPH_METRICS;

typedef int DWRITE_GLYPH_OFFSET;
...
typedef int IDWriteFontFileLoader;

typedef int IDWriteLocalFontFileLoader;

// TODO: this type is limited to platform 'windows6.1'
typedef int IDWriteFontFileStream;

// TODO: this type is limited to platform 'windows6.1'
typedef int IDWriteFontFile;
...
typedef int DWRITE_MATRIX;

// TODO: this type is limited to platform 'windows6.1'
typedef int IDWriteRenderingParams;

// TODO: this type is limited to platform 'windows6.1'
typedef int IDWriteFontFace;

// TODO: this type is limited to platform 'windows6.1'
typedef int IDWriteFontCollectionLoader;

// TODO: this type is limited to platform 'windows6.1'
typedef int IDWriteFontFileEnumerator;

// TODO: this type is limited to platform 'windows6.1'
typedef int IDWriteLocalizedStrings;

// TODO: this type is limited to platform 'windows6.1'
typedef int IDWriteFontCollection;

// TODO: this type is limited to platform 'windows6.1'
typedef int IDWriteFontList;

// TODO: this type is limited to platform 'windows6.1'
typedef int IDWriteFontFamily;

// TODO: this type is limited to platform 'windows6.1'
typedef int IDWriteFont;
...
typedef int DWRITE_TEXT_RANGE;

typedef int DWRITE_FONT_FEATURE;

typedef int DWRITE_TYPOGRAPHIC_FEATURES;

typedef int DWRITE_TRIMMING;

// TODO: this type is limited to platform 'windows6.1'
typedef int IDWriteTextFormat;

// TODO: this type is limited to platform 'windows6.1'
typedef int IDWriteTypography;
...
typedef int DWRITE_SCRIPT_ANALYSIS;
...
typedef int DWRITE_LINE_BREAKPOINT;
...
typedef int IDWriteNumberSubstitution;

typedef int DWRITE_SHAPING_TEXT_PROPERTIES;

typedef int DWRITE_SHAPING_GLYPH_PROPERTIES;

// TODO: this type is limited to platform 'windows6.1'
typedef int IDWriteTextAnalysisSource;

// TODO: this type is limited to platform 'windows6.1'
typedef int IDWriteTextAnalysisSink;

// TODO: this type is limited to platform 'windows6.1'
typedef int IDWriteTextAnalyzer;

typedef int DWRITE_GLYPH_RUN;

typedef int DWRITE_GLYPH_RUN_DESCRIPTION;

typedef int DWRITE_UNDERLINE;

typedef int DWRITE_STRIKETHROUGH;

typedef int DWRITE_LINE_METRICS;

typedef int DWRITE_CLUSTER_METRICS;

typedef int DWRITE_TEXT_METRICS;

typedef int DWRITE_INLINE_OBJECT_METRICS;

typedef int DWRITE_OVERHANG_METRICS;

typedef int DWRITE_HIT_TEST_METRICS;

// TODO: this type is limited to platform 'windows6.1'
typedef int IDWriteInlineObject;

// TODO: this type is limited to platform 'windows6.1'
typedef int IDWritePixelSnapping;

// TODO: this type is limited to platform 'windows6.1'
typedef int IDWriteTextRenderer;

// TODO: this type is limited to platform 'windows6.1'
typedef int IDWriteTextLayout;

// TODO: this type is limited to platform 'windows6.1'
typedef int IDWriteBitmapRenderTarget;

// TODO: this type is limited to platform 'windows6.1'
typedef int IDWriteGdiInterop;
...
// TODO: this type is limited to platform 'windows6.1'
typedef int IDWriteGlyphRunAnalysis;

// TODO: this type is limited to platform 'windows6.1'
typedef int IDWriteFactory;
...
typedef int DWRITE_FONT_METRICS1;

typedef int DWRITE_CARET_METRICS;

typedef int DWRITE_PANOSE;

typedef int DWRITE_UNICODE_RANGE;

typedef int DWRITE_SCRIPT_PROPERTIES;

typedef int DWRITE_JUSTIFICATION_OPPORTUNITY;

// TODO: this type is limited to platform 'windows8.0'
typedef int IDWriteFactory1;

// TODO: this type is limited to platform 'windows8.0'
typedef int IDWriteFontFace1;

// TODO: this type is limited to platform 'windows8.0'
typedef int IDWriteFont1;

// TODO: this type is limited to platform 'windows8.0'
typedef int IDWriteRenderingParams1;

// TODO: this type is limited to platform 'windows8.0'
typedef int IDWriteTextAnalyzer1;

// TODO: this type is limited to platform 'windows8.0'
typedef int IDWriteTextAnalysisSource1;

// TODO: this type is limited to platform 'windows8.0'
typedef int IDWriteTextAnalysisSink1;

// TODO: this type is limited to platform 'windows8.0'
typedef int IDWriteTextLayout1;
...
// TODO: this type is limited to platform 'windows8.0'
typedef int IDWriteBitmapRenderTarget1;
...
typedef int DWRITE_TEXT_METRICS1;

// TODO: this type is limited to platform 'windows8.1'
typedef int IDWriteTextRenderer1;

// TODO: this type is limited to platform 'windows8.1'
typedef int IDWriteTextFormat1;

// TODO: this type is limited to platform 'windows8.1'
typedef int IDWriteTextLayout2;

// TODO: this type is limited to platform 'windows8.1'
typedef int IDWriteTextAnalyzer2;

// TODO: this type is limited to platform 'windows8.1'
typedef int IDWriteFontFallback;

// TODO: this type is limited to platform 'windows8.1'
typedef int IDWriteFontFallbackBuilder;

// TODO: this type is limited to platform 'windows8.1'
typedef int IDWriteFont2;

// TODO: this type is limited to platform 'windows8.1'
typedef int IDWriteFontFace2;

typedef int DWRITE_COLOR_GLYPH_RUN;

// TODO: this type is limited to platform 'windows8.1'
typedef int IDWriteColorGlyphRunEnumerator;

// TODO: this type is limited to platform 'windows8.1'
typedef int IDWriteRenderingParams2;

// TODO: this type is limited to platform 'windows8.1'
typedef int IDWriteFactory2;
...
typedef int DWRITE_FONT_PROPERTY;
...
typedef int IDWriteRenderingParams3;

// TODO: this type is limited to platform 'windows10.0.10240'
typedef int IDWriteFactory3;

// TODO: this type is limited to platform 'windows10.0.10240'
typedef int IDWriteFontSet;

typedef int IDWriteFontSetBuilder;

// TODO: this type is limited to platform 'windows6.1'
typedef int IDWriteFontCollection1;

// TODO: this type is limited to platform 'windows10.0.10240'
typedef int IDWriteFontFamily1;

// TODO: this type is limited to platform 'windows10.0.10240'
typedef int IDWriteFontList1;

// TODO: this type is limited to platform 'windows10.0.10240'
typedef int IDWriteFontFaceReference;

// TODO: this type is limited to platform 'windows10.0.10240'
typedef int IDWriteFont3;

// TODO: this type is limited to platform 'windows10.0.10240'
typedef int IDWriteFontFace3;

typedef int IDWriteStringList;

// TODO: this type is limited to platform 'windows8.1'
typedef int IDWriteFontDownloadListener;

// TODO: this type is limited to platform 'windows8.1'
typedef int IDWriteFontDownloadQueue;

typedef int IDWriteGdiInterop1;

typedef int DWRITE_LINE_METRICS1;
...
typedef int DWRITE_LINE_SPACING;

// TODO: this type is limited to platform 'windows8.1'
typedef int IDWriteTextFormat2;

// TODO: this type is limited to platform 'windows8.1'
typedef int IDWriteTextLayout3;

typedef int DWRITE_COLOR_GLYPH_RUN1;

typedef int DWRITE_GLYPH_IMAGE_DATA;

typedef int IDWriteColorGlyphRunEnumerator1;

typedef int IDWriteFontFace4;

typedef int IDWriteFactory4;

typedef int IDWriteFontSetBuilder1;

typedef int IDWriteAsyncResult;

typedef int DWRITE_FILE_FRAGMENT;

typedef int IDWriteRemoteFontFileStream;
...
typedef int IDWriteRemoteFontFileLoader;

typedef int IDWriteInMemoryFontFileLoader;

typedef int IDWriteFactory5;

typedef int DWRITE_FONT_AXIS_VALUE;

typedef int DWRITE_FONT_AXIS_RANGE;
...
typedef int IDWriteFactory6;

typedef int IDWriteFontFace5;

typedef int IDWriteFontResource;

typedef int IDWriteFontFaceReference1;

typedef int IDWriteFontSetBuilder2;

typedef int IDWriteFontSet1;

typedef int IDWriteFontList2;

typedef int IDWriteFontFamily2;

typedef int IDWriteFontCollection2;

typedef int IDWriteTextLayout4;

typedef int IDWriteTextFormat3;

typedef int IDWriteFontFallback1;

typedef int IDWriteFontSet2;

typedef int IDWriteFontCollection3;

typedef int IDWriteFactory7;
...
//--------------------------------------------------------------------------------
// TODO: this type is limited to platform 'windows6.1'
/*HRESULT*/void DWriteCreateFactory();
